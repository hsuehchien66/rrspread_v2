...
#'
#' This function is to sample trees from BactDating posterior to generate confidence interval
#'
#' @param metadata metadata, should include GPSC, region, longitude, latitude, collection year
#' @param bd_res object from BactDating 
#' @param initial_window window size of divergence time
#' @param Ntreestosample number of trees to sample from
#' @param divtime_nboot number of bootstrap sampling
#' @param upper_window maximum year of divergence
#' @return a table of the relationship between pairwise divergence time and physical distance with confidence interval 
#' @export
